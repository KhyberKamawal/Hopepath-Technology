...
import { Globe, Code, Smartphone, TrendingUp, Server, Users, Check, ArrowRight } from 'lucide-react';
...
const Services = () => {
  return (
    <div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          >
            ...
            <p className="text-xl text-gray-600 max-w-3xl mx-auto">
              We follow a structured approach to ensure quality, efficiency, and client satisfaction.
            </p>
          </motion.div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
            {[
              ...
              },
              {
                step: '04',
                title: 'Deployment',
                description: 'Testing, launching, and providing ongoing support and maintenance'
              }
            ].map((process, index) => (
              <motion.div
                key={process.step}
      ...
      {/* CTA Section */}
      <section className="py-20 bg-gradient-to-r from-purple-600 via-indigo-600 to-blue-700">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          >
            ...
            <button className="bg-white text-purple-600 px-8 py-3 rounded-lg text-lg font-medium hover:bg-gray-100 transition-all duration-200 inline-flex items-center group shadow-lg hover:shadow-xl transform hover:-translate-y-1">
              Contact Us Today
